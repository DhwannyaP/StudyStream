  ...
  const handleAuthSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        setTimeout(() => {
          console.log("Navigating after login:", user.role);
          if (user.role === "teacher") {
            setLocation("/teacher/dashboard");
          } else {
            setLocation("/student/dashboard");
        ...
        // Add a small delay to ensure state updates are processed
        setTimeout(() => {
          console.log("Navigating after register:", user.role);
          if (user.role === "teacher") {
            setLocation("/teacher/dashboard");
          } else {
            setLocation("/student/dashboard");
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          ...
          <p className="text-xl text-blue-100 mb-12 max-w-2xl mx-auto animate-slide-up">
            Connect teachers and students through real-time collaboration,
            shared notes, and interactive learning experiences.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
            ...
            <Card className="transform hover:scale-105 transition-transform duration-300 animate-slide-up cursor-pointer shadow-2xl">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="font-heading text-2xl font-bold text-edu-text-primary mb-4">
                  Teacher Portal
                </h3>
                <p className="text-edu-text-secondary mb-6">
                  Upload and manage your course materials, track student
                  engagement, and facilitate collaborative learning.
                </p>
            ...
            <Card className="transform hover:scale-105 transition-transform duration-300 animate-slide-up cursor-pointer shadow-2xl">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-edu-text-secondary mb-6">
                  Access course materials, collaborate with peers, join study
                  groups, and engage in real-time discussions.
                </p>
                <div className="space-y-2">
                  <Button
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center text-white">
            ...
            <p className="text-blue-100">
              Highlight and annotate documents together in real-time
            </p>
          </div>
          <div className="text-center text-white">
            ...
            <p className="text-blue-100">
              Connect through video calls and screen sharing
            </p>
          </div>
          <div className="text-center text-white">
            ...
            <p className="text-blue-100">
              Create and join study groups for better learning
            </p>
          </div>
        </div>
      </div>
